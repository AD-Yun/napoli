...
public class JobKoreaQNAList extends KnowListFilter {
	...
	public JobKoreaQNAList() {
		...
		/* pattern 1 */
		String prefix = "<!--도와주세요-->";
		String suffix = "<!--본문내용 끝//-->";
		String delim = "<td colspan=\"2\" class=\"td02\">";
		// q_regexp
		String regexp = "<a href=[^\\?]*\\?Q_Idx=([^&]*)" ;
	...
	public String getNextListUrl(String url) throws VeniceException {
		String currentURL = "http://www.jobkorea.co.kr/Knowledge/QA_Main.asp" + "?page=" + this.currentPageNum;
		this.currentPageNum++;
		return currentURL;
	}
}
